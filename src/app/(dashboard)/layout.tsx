...
export default function DashboardLayout({
  ...
  const navItems = [
    ...
    { name: 'Products', href: '/dashboard/products', icon: '📦', color: 'from-purple-500 to-pink-500' },
    { name: 'Orders', href: '/dashboard/orders', icon: '🛒', color: 'from-green-500 to-teal-500' },
    { name: 'Analytics', href: '/dashboard/analytics', icon: '📈', color: 'from-yellow-500 to-orange-500' },
    { name: 'Messages', href: '/dashboard/messages', icon: '💬', color: 'from-indigo-500 to-purple-500' },
    { name: 'Calendar', href: '/dashboard/calendar', icon: '📅', color: 'from-red-500 to-pink-500' },
    { name: 'Settings', href: '/dashboard/settings', icon: '⚙️', color: 'from-gray-500 to-slate-500' },
    { name: 'Support', href: '/dashboard/support', icon: '🎫', color: 'from-emerald-500 to-green-500' },
  ]

  // Quick actions
  const quickActions = [
    { name: 'Add Product', href: '/dashboard/products/add', icon: '➕', color: 'purple' },
    { name: 'New Order', href: '/dashboard/orders/new', icon: '📝', color: 'pink' },
    { name: 'Send Message', href: '/dashboard/messages/new', icon: '✉️', color: 'blue' },
  ]
          ...
          <div className="p-4 border-b border-white/10">
            <div className="flex items-center justify-between">
              <Link href="/dashboard" className="flex items-center gap-2">
                ...
                <span className="text-white font-bold text-lg">StudyAbroad</span>
              </Link>
              <button
                onClick={() => setIsSidebarOpen(false)}
